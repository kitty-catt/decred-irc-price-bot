...
exports.module = function() {
	this.onMessage = function(user, message) {
		...
		if (message == st+"VERSION"+st) {
			this.server.notice(user, settings.globalNick + " by Dirbaio, Nina, LifeMushroom, and AlphaTech. Running on Node.js " + process.versions.node + " (" + os.type() + " " + os.release() + " " + os.arch() + ") https://github.com/LifeMushroom/Modular-Node.js-IRC-Bot");
